...
title: Java基础-面向对象思想
abbrlink: 39756
date: 2022-10-18 00:37:48
tags: 面向对象
categories: Java
summary: 面向对象三大特性:封装，继承和多态，本篇将详细介绍。
---
...
### 继承
使用已经存在的类的定义作为基础建立新的类的技术，新的类即子类会继承父类的各个属性和相关方法并可以增加新的功能或修改原有的功能。
...
虚拟方法的调用：
  子类定义了同父类同方法同参数的方法，在多态情况下，将此时父类的方法称为虚拟方法，父类根据赋值给它的不同子类对象，动态调用属于子类的该方法，这样的方法调用在编译期是无法确定的。
...
- [面向对象思想](https://github1s.com/CyC2018/CS-Notes/blob/master/notes/%E9%9D%A2%E5%90%91%E5%AF%B9%E8%B1%A1%E6%80%9D%E6%83%B3.md)
